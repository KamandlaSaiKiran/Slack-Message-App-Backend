...
export const deleteWorkspaceService = async (workspaceId, userId) => {
  try {
    ...
    throw new ClientError({
      explanation: 'user is either not a member or an admin of the workplace',
...
export const updateWorkspaceService = async (
  ...
  try {
    ...
    if (!isAdmin) {
      throw new ClientError({
        explanation: 'User is not an admin of the the workspace',
...
export const addMemberToWorkspaceService = async (
  ...
  try {
    ...
    if (isMember) {
      throw new ClientError({
        explanation: 'User is already a member of the worspace',
...
export const addChannelToWorkspaceService = async (
  ...
  try {
    console.log('Workspace id inside the service layer is ', workspaceId);
    const workspace =
    ...
    console.log('addChannel to workspace Service Error', error);
    throw error;
  }
};
